...
public class ExampleUnitTest {
    ...
    {
        Address adresse = new Address("18", 12, "AvenueMaillet", "Moncton", "E1A2EA");
        assertEquals("18", Address.getStreetNumber());
        assertEquals(12, Address.getApartementNumber());
        assertEquals("AvenueMaillet", Address.getStreetName());
        assertEquals("E1A2EA", Address.getPostalCode());
    }
