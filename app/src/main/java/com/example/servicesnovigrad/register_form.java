    ...
    public void submitOnClick(View view) {
        ...
        //checking if the inputs are correct
        {
            ...
            if (!password1.getText().toString().equals(password2.getText().toString())) {
                Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Passwords do not match, " + firstName.getText(), Snackbar.LENGTH_LONG);
                snackbar.show();
                return;
            }

            //checks if the email is a correct email address
        ...
        if(employee.isChecked()){
            user = new Employee(username.getText().toString(), password1.getText().toString(), email.getText().toString(), firstName.getText().toString(), lastName.getText().toString(), null);

        }
        else{
            user = new Client(username.getText().toString(), password1.getText().toString(), email.getText().toString(), firstName.getText().toString(), lastName.getText().toString(), null);
        }
